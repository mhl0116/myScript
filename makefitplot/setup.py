...
"yTitle": "",\
"savepath": "/home/mhl/public_html/2017/20170505_checkResiduals/Z4L/",\
...
config["roorealvars"][-1] = ROOT.RooRealVar("etaL3","",-2.5,2.5)
config["plotArgList"] = ROOT.RooArgList(config["roorealvars"][0],config["roorealvars"][1])
...
config["roorealvars"][-1] = ROOT.RooRealVar("etaL2","",-2.5,2.5)
config["plotArgList"] = ROOT.RooArgList(config["roorealvars"][0],config["roorealvars"][1])
...
config["roorealvars"][-1] = ROOT.RooRealVar("etaL1","",-2.5,2.5)
config["plotArgList"] = ROOT.RooArgList(config["roorealvars"][0],config["roorealvars"][1])
