...
#w.factory("Exponential::bkg(x, tau[0.0241])")
#w.factory("Exponential::bkg(x, tau[-0.3,-1,1])")

w.factory('Bernstein::bkg(x, {b0[1,-100,100], b1[10,-100,100], b2[10,-100,100]})')
##4mu
#w.factory('Bernstein::bkg(x, {b0[2.98268], b1[4.06110], b2[6.82505]})')
##4e
#w.factory('Bernstein::bkg(x, {b0[2.72125], b1[6.46527], b2[7.92145]})')
##2e2mu
#w.factory('Bernstein::bkg(x, {b0[1.85071], b1[1.83668], b2[9.37190]})')
...
#w.factory('SUM:model(f1[0.8,0,1]*BWxDCB, bkg)')
w.factory('SUM:model(f1[0.8,0,1]*bw, bkg)')
...
pdf.paramOn(xframe, RooFit.Layout(0.17, 0.4, 0.9), RooFit.Format("NE", RooFit.FixedPrecision(6)))

#plot again in case curve is behind text
dataHist1.plotOn(xframe, RooFit.MarkerStyle(20), RooFit.MarkerColor(1))
pdf.plotOn(xframe, RooFit.LineColor(4), RooFit.LineWidth(2) )
if pdfName == 'model':
   pdf.plotOn(xframe, RooFit.LineColor(4), RooFit.LineWidth(2), RooFit.Components("bkg"), RooFit.LineStyle(kDashed))
...
if dof > 0:
   ...
   latex.DrawLatex(0.75, 0.85, "#chi^{2} = %.3f" %(chi2))
