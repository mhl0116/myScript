...
saveName = 'DY15_MC_pTResidual_useLepFSR_0_0p9'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_useLepFSRForMassZ/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2mu.root',
'tree1': 'passedEvents',
'binInfo': [100, -0.15, 0.15],
'vars1': ['(pT1-genLep_pt1)/genLep_pt1', '(pT2-genLep_pt2)/genLep_pt2'],
...
saveName = 'DY15_MC_pTResidual_useLepFSR_0p9_1p8'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_useLepFSRForMassZ/',
...
saveName = 'DY15_MC_pTResidual_useLepFSR_1p8_2p4'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
saveName = 'H15_MC_pTResidual_1p8_2p4'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
'cuts1': ['passedFullSelection && finalState == 1 && abs(etaL1) < 2.4 && abs(etaL1) > 1.8', \
          'passedFullSelection && finalState == 1 && abs(etaL2) < 2.4 && abs(etaL2) > 1.8', \
          'passedFullSelection && finalState == 1 && abs(etaL3) < 2.4 && abs(etaL3) > 1.8', \
          'passedFullSelection && finalState == 1 && abs(etaL4) < 2.4 && abs(etaL4) > 1.8'],
'weight1': ['1', '1', '1', '1'],
'xTitle': '(pT_{reco}-pT_{gen})/pT_{gen}',
'yTitle': '',
'savePath': savePath,
...
saveName = 'H15_MC_pTResidual_afterCorr_1p8_2p4'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
saveName = 'H15_MC_pTResidual_afterCorr_0p9_1p8'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
'vars1': ['(pTL1-pTGENL1)/pTGENL1', \
          ...
          '(pTL3-pTGENL3)/pTGENL3', \
          '(pTL4-pTGENL4)/pTGENL4'],
'cuts1': ['passedFullSelection && finalState == 1 && abs(etaL1) < 1.8 && abs(etaL1) > 0.9', \
          'passedFullSelection && finalState == 1 && abs(etaL2) < 1.8 && abs(etaL2) > 0.9', \
          'passedFullSelection && finalState == 1 && abs(etaL3) < 1.8 && abs(etaL3) > 0.9', \
          'passedFullSelection && finalState == 1 && abs(etaL4) < 1.8 && abs(etaL4) > 0.9'],
'weight1': ['1', '1', '1', '1'],
'xTitle': '(pT_{reco}-pT_{gen})/pT_{gen}',
'yTitle': '',
'savePath': savePath,
...
saveName = 'H15_MC_pTResidual_0p9_1p8'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
saveName = 'H15_MC_pTResidual_afterCorr_0_0p9'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
'vars1': ['(pTL1-pTGENL1)/pTGENL1', \
          ...
          '(pTL3-pTGENL3)/pTGENL3', \
          '(pTL4-pTGENL4)/pTGENL4'],
'cuts1': ['passedFullSelection && finalState == 1 && abs(etaL1) < 0.9', \
          'passedFullSelection && finalState == 1 && abs(etaL2) < 0.9', \
          'passedFullSelection && finalState == 1 && abs(etaL3) < 0.9', \
          'passedFullSelection && finalState == 1 && abs(etaL4) < 0.9'],
'weight1': ['1', '1', '1', '1'],
'xTitle': '(pT_{reco}-pT_{gen})/pT_{gen}',
'yTitle': '',
'savePath': savePath,
...
saveName = 'H15_MC_pTResidual_0_0p9'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/liteUFHZZ4LAnalyzer/Ntuples/',
'rootfile1': 'test_tripleGauss_symErrHESSE_corrMuPtScale_ebeFrommZReco_80_100.root',
'tree1': 'passedEvents',
'binInfo': [100, 105, 140],
'vars1': ['mass4l'],
...
'rootfile1': 'mH_125_v1_20160110_corrKalmanFilterVersion.root',
'tree1': 'passedEvents',
'binInfo': [100, 105, 140],
'vars1': ['mass4lREFIT'],
'cuts1': ['passedFullSelection && finalState == 1'], #
...
saveName = 'm4lrefit_4mu_8tevMCPara_nocorrpTScale'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
'rootfile1': 'test_tripleGauss_symErrHESSE_ebeFrommZReco_60_120.root',
'tree1': 'passedEvents',
'binInfo': [100, 105, 140],
'vars1': ['mass4lREFIT'],
'cuts1': ['passedFullSelection && finalState == 1'], #
...
saveName = 'm4lrefit_4mu_8tevMCPara'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
'rootfile1': 'test_tripleGauss_symErrHESSE_corrMuPtScale_ebeFrommZReco_60_120.root',
'tree1': 'passedEvents',
'binInfo': [100, 105, 140],
'vars1': ['mass4lREFIT'],
...
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
'rootfile1': 'test.root',
#'rootfile1': 'test_eEBE_80_100_7bins_doLambda1.root',
'tree1': 'passedEvents',
'binInfo': [100, 105, 140],
'vars1': ['mass4l'],
...
saveName = 'm4lreco_4mu_testCorrOnHSample'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
...
saveName = 'm4lrefit_4mu_testCorrOnHSample'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
...
saveName = 'm4lreco_4mu_8tevMCPara_noFSR'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
...
'binInfo': [100, 105, 140],
'vars1': ['mass4l'],
'cuts1': ['passedFullSelection && finalState == 1 && nFSRPhotons == 0 && mass4l > 105 && mass4l < 140'], #
'weight1': ['1'],
'xTitle': 'mass4l',
'yTitle': '',
'savePath': savePath,
...
saveName = 'm4lrefit_4mu_8tevMCPara_noFSR'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
...
'binInfo': [100, 105, 140],
'vars1': ['mass4lREFIT'],
'cuts1': ['passedFullSelection && finalState == 1 && nFSRPhotons == 0 && mass4lREFIT > 105 && mass4lREFIT < 140'], #
'weight1': ['1'],
'xTitle': 'mass4lREFIT',
'yTitle': '',
'savePath': savePath, 
...
saveName = 'm4lreco_4mu_8tevMCPara'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
...
saveName = 'm4lreco_4mu_8tevMCPara_nocorrpTScale'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
...
'binInfo': [100, 50, 105],
'vars1': ['GENmassZ1'],
'cuts1': ['passedFullSelection && passedFiducialSelection && finalState == 2'],
'weight1': ['1'],
'xTitle': 'GENmassZ1',
'yTitle': '',
'savePath': savePath,
...
'binInfo': [100, 50, 105],
'vars1': ['GENmassZ1'],
'cuts1': ['passedFullSelection && passedFiducialSelection && finalState == 3'],
'weight1': ['1'],
'xTitle': 'GENmassZ1',
'yTitle': '',
'savePath': savePath,
...
'binInfo': [100, 50, 105],
'vars1': ['GENmassZ1'],
'cuts1': ['passedFullSelection && passedFiducialSelection && finalState == 4'],
'weight1': ['1'],
'xTitle': 'GENmassZ1',
'yTitle': '',
'savePath': savePath,
...
saveName = 'massZ_2015MC_noMuonPtScaleCorr'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2mu.root',
...
saveName = 'massZ_2015MC_addMuonPtScaleCorr'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2mu.root',
...
saveName = 'GENMZ_2015MC_addMuonPtScaleCorr_massZ_60_120'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2mu.root',
...
saveName = 'GENMZ_2015MC_addMuonPtScaleCorr_massZ_80_100'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2mu.root',
...
'binInfo': [100, 80, 100],
'vars1': ['genzm'],
'cuts1': [' genLep_pt1 > 0 && genLep_pt2 > 0 && massZ> 80 && massZ < 100 && genzm > 80 && genzm < 100'], #
'weight1': ['1'],
'xTitle': 'GENMZ',
'yTitle': '',
'savePath': savePath,
...
saveName = 'GENMZ_2015MC_e_massZ_80_100'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_useLepFSRForMassZ/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2e.root',
...
'binInfo': [100, 80, 100],
'vars1': ['genzm'],
'cuts1': [' genLep_pt1 > 0 && genLep_pt2 > 0 && massZ> 80 && massZ < 100'], #
'weight1': ['1'],
'xTitle': 'GENMZ',
'yTitle': '',
'savePath': savePath,
...
saveName = 'massZ_2015MC_useLepFSRForMassZ'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_useLepFSRForMassZ/',
'rootfile1': 'DYJetsToLL_M-50_kalman_v4_m2mu.root',
...
'binInfo': [300, 60, 120],
'vars1': ['massZ'],
'cuts1': [' genLep_pt1 > 0 && genLep_pt2 > 0 && massZ > 60 && massZ < 120 && lep1_ecalDriven && lep2_ecalDriven'], #
'weight1': ['1'],
'xTitle': 'massZ',
'yTitle': '',
'savePath': savePath,
...
saveName = 'Z4L_4mu_8tevMCPara'
paraConfigs[saveName] = \
{\
'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/HiggsMass_HZZ4L/packages/liteUFHZZ4LAnalyzer/Ntuples/',
#'rootfile1': 'mH_125_addLepErrREFIT.root',
'rootfile1': 'test_tripleGauss_symErrHESSE_corrMuPtScale_8TeVZ1Para.root',
'tree1': 'passedEvents',
'binInfo': [100, 80, 100],
'vars1': ['mass4l'],
'cuts1': ['passedFullSelection && finalState == 1'], #
...
'cuts1': ['passedFullSelection && finalState == 1 && mass4lREFIT > 105 && mass4lREFIT < 140'], #
'weight1': ['1'],
'xTitle': '(m4lrefit-genm4l)/m4lErrREFIT',
'yTitle': '',
'savePath': savePath,
'saveName': saveName, #
'latexNote1': ' ',
...
'binInfo': [100, 60, 120],
'vars1': ['massZ'],
'cuts1': ['massZ > 60 && massZ < 120 && sqrt((pT1*pT1+pT2*pT2)/2) > 50 && sqrt((pT1*pT1+pT2*pT2)/2) < 55'], #
'weight1': ['1'],
'xTitle': 'massZ',
'yTitle': '',
'savePath': savePath,
...
'binInfo': [100, 80, 100],
'vars1': ['massZ'],
'cuts1': [skimmedDY_cutOnGEN + ' 1'],# + ' genLep_pt1 > 0 && genLep_pt2 > 0 && abs(genLep_eta1) < 2.4 && abs(genLep_eta1) > 1.8'],
'weight1': ['1'],
'xTitle': 'mass2l',
'yTitle': '',
'savePath': savePath,
...
saveName = 'DY15_Zmumu_m2l_oneBarrel_oneEndcap'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
'binInfo': [100, 80, 100],
'vars1': ['massZ'],
'cuts1': [skimmedDY_cutOnGEN + ' ((abs(eta1)<0.9 && abs(eta2)>1.8) || (abs(eta1)>1.8 && abs(eta2)<0.9))'],# + ' genLep_pt1 > 0 && genLep_pt2 > 0 && abs(genLep_eta1) < 2.4 && abs(genLep_eta1) > 1.8'],
'weight1': ['1'],
'xTitle': 'mass2l',
'yTitle': '',
'savePath': savePath,
...
saveName = 'DY15_Zmumu_m2l_twoInBarrel'
paraConfigs[saveName] = \
{\
#'rootPath1': mc2015_dy_path_v4,
#'rootPath1': '/raid/raid9/mhl/HZZ4L_Run2_post2016ICHEP/outputRoot/DY_2015MC_kalman_v4_NOmassZCut_addpTScaleCorrection/',
...
'binInfo': [100, 80, 100],
'vars1': ['massZ'],
'cuts1': [skimmedDY_cutOnGEN + ' (abs(eta1)<0.9 && abs(eta2)<0.9)'],# + ' genLep_pt1 > 0 && genLep_pt2 > 0 && abs(genLep_eta1) < 2.4 && abs(genLep_eta1) > 1.8'],
'weight1': ['1'],
'xTitle': 'mass2l',
'yTitle': '',
'savePath': savePath,
