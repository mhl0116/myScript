...
*/
   if (abs(*eta1)<0.7) pterr1_corr *= 1.171;
   if (abs(*eta1)>=0.7 && abs(*eta1)<=1) pterr1_corr *= 1.139;
   if (abs(*eta1)>=1 && abs(*eta1)<=1.5) pterr1_corr *= 1.117;
   if (abs(*eta1)>1.5) pterr1_corr *= 1.078;

   if (abs(*eta2)<0.7) pterr2_corr *= 1.171;
   if (abs(*eta2)>=0.7 && abs(*eta2)<=1) pterr2_corr *= 1.139;
