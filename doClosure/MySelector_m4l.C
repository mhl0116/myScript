...
#include "MySelector_m4l.C.h"
#include <TH2.h>
#include <TStyle.h>

void MySelector_m4l.C::Begin(TTree * /*tree*/)
{
...
void MySelector_m4l.C::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t MySelector_m4l.C::Process(Long64_t entry)
{
   ...
   double dm4 = (lep1+lep2+lep3_lep4p).M()-(lep1+lep2+lep3+lep4).M();
...
void MySelector_m4l.C::SlaveTerminate()
{
...
void MySelector_m4l.C::Terminate()
{
