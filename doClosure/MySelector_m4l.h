...
#ifndef MySelector_m4l.C_h
#define MySelector_m4l.C_h
...
class MySelector_m4l.C : public TSelector {
public :
...
*/
   ...
   MySelector_m4l.C(TTree * /*tree*/ =0):
     nEvents(0), mass4lErr_uncorr_sum(0), mass4lErr_corr_sum(0) { }
   virtual ~MySelector_m4l.C() { }
   ...
   ClassDef(MySelector_m4l.C,0);

};

#endif

#ifdef MySelector_m4l.C_cxx
void MySelector_m4l.C::Init(TTree *tree)
{
...
Bool_t MySelector_m4l.C::Notify()
{
...
#endif // #ifdef MySelector_m4l.C_cxx
